  ...
  return (
    <main className="w-screen h-screen bg-slate-200">
        ...
        <section className="flex flex-col items-center justify-center gap-4 h-[87.5vh] overflow-auto">
            <div>
                <p className="text-blue-800 font-bold text-xs sm:text-xl md:text-2xl lg:text-4xl">Unlock endless internship & attachment possibilities with <br /> our student-centric attachment platform today!
                </p>
            </div>
            <div className="flex flex-col items-center justify-center">
                <p className="text-[8px] sm:text-sm md:text-base font-semibold text-gray-500">Empower your future with our comprehensive software platform, connecting students to</p>
                <p className="text-[8px] sm:text-sm md:text-base font-semibold text-gray-500">a vast array of internship and attachment opportunities, ensuring you</p>
                <p className="text-[8px] sm:text-sm md:text-base font-semibold text-gray-500">find the perfect match to kickstart your career journey.</p>
            </div>
